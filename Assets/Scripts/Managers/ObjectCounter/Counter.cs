...
{
    public const int MAX_REPORT = 65535;
    ...
    private NativeArray<ReportResultEntry> reportRequests = new(MAX_REPORT, Allocator.Persistent);
    public NativeArray<int> reportCount = new(1, Allocator.Persistent);
    public unsafe ReportResultEntry* ReportRequestsPtr => (ReportResultEntry*)reportRequests.GetUnsafePtr();
    public unsafe int* ReportCountPtr => (int*)reportCount.GetUnsafePtr();
